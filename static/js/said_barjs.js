function search_bard_state_city() {
    let search_np = document.getElementById("top_state_citysearch_input").value
...
function search_bard_colage() {
    let search_np = document.getElementById("college_search_input").value
...
function search_bard_btechexam() {
    let search_np = document.getElementById("btechexam_search_input").value
...
function search_bard_cuttoff() {
    let search_np = document.getElementById("cutt_off_search_input").value
